$_GET({
  ...
  html: /*html*/`
    <div class="row">
      ...
      <div><br></div>
      <div><i>Exemplum</i>:<span style="white-space: pre;">	</span>vorāgō <div class="area">водоворот</div> → vorāgō <div class="area">vo-rā́-gō</div></div>
      <div><br></div>
      <div>Patroclus <div class="area" data-key="Pá-tro-clus">Патрокл</div></div>
      ...
      <div>Eumenidēs <div class="area" data-key="Eu-mé-ni-dēs">эвмениды <i>(фурии)</i></div></div>
      ...
      <div>kalendae <div class="area" data-key="ka-lén-dae">калéнды <i>(1-й день мемяца)</i></div></div>
