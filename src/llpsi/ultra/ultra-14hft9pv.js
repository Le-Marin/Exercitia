$_GET({
  ...
  html: /*html*/`
    <div class="row">
      ...
      <div>4. в поющем голосе <div class="area" data-key="in vōce cantante | in vōce cantantī"></div></div>
      <div>5. из слушающих учеников <div class="area" data-key="ē discipulīs audientibus"></div></div>
      ...
      <div>3. к матери, зовущей меня <div class="area" data-key="ad mātrem mē vocantem"></div></div>
      <div>4. от зверей, населяющих леса <div class="area" data-key="ā bēstiīs silvās incolentibus"></div></div>
      <div>5. без солдат, носящих дротики <div class="area" data-key="sine mīlitibus pīla gerentibus"></div></div>
      <div>6. с коня, везущего Юлия <div class="area" data-key="dē equō Iūlium vehente"></div></div>
      <div>7. около города, имеющего тысячу жителей <div class="area" data-key="prope oppidum centum incolās habēns | prope urbem centum incolās habentem"></div></div>
      <div>8. в человеке, стоящим перед нами <div class="area" data-key="in homine ante nōs stante"></div></div>
    </div>
  `
});